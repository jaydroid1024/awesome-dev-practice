...
public class RomUtils {
    ...
    public static String getBrandName(){//品牌名字
        return (TextUtils.isEmpty(Build.BRAND) ? (TextUtils.isEmpty(Build.MANUFACTURER) ? (TextUtils.isEmpty(Build.PRODUCT) ? "unknown" : Build.PRODUCT) : Build.MANUFACTURER) : Build.BRAND);
    }
