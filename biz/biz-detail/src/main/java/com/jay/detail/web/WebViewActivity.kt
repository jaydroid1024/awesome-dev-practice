...
class WebViewActivity : BaseMVPActivity<WebContract.View, WebPresenter>(), WebContract.View {
    ...
    override fun getLayoutResId(): Int {
        return R.layout.biz_detail_activity_web_view
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.biz_detail_menu_web, menu)
    ...
    private fun showMoreDialog() {
        ...
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_favorite_white, "收藏"))
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_share, "朋友圈"))
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_wx_friend, "微信好友"))
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_link, "复制链接"))
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_refresh, "刷新"))
        dataList.add(WebOptBean(R.drawable.biz_detail_ic_browser, "浏览器打开"))
