...
public class XunfeiMainActivity extends Activity implements OnClickListener{
	...
	private class SimpleAdapter extends BaseAdapter{
		...
		{	   		  
			if(null == convertView){
				LayoutInflater factory = LayoutInflater.from(XunfeiMainActivity.this);
				View mView = factory.inflate(R.layout.list_items, null);
				convertView = mView;
			}
			Button btn = (Button)convertView.findViewById(R.id.btn);
			btn.setOnClickListener(XunfeiMainActivity.this);
			btn.setTag(position);
