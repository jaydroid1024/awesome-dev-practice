...
public class XunFeiSpeechMainActivity extends Activity implements OnClickListener {

	private static final String TAG = XunFeiSpeechMainActivity.class.getSimpleName();
	...
	public void onClick(View view) {
		...
		case 0:
			// 语音转写
			intent = new Intent(XunFeiSpeechMainActivity.this, IatDemo.class);
			break;
		case 1:
			// 语法识别
			intent = new Intent(XunFeiSpeechMainActivity.this, AsrDemo.class);
			break;
		case 2:
			// 语义理解
		...
		case 3:
			// 语音合成
			intent = new Intent(XunFeiSpeechMainActivity.this, TtsDemo.class);
			break;
		case 4:
			// 语音评测
			intent = new Intent(XunFeiSpeechMainActivity.this, IseDemo.class);
			break;
		case 5:
			// 唤醒
	...
	private class SimpleAdapter extends BaseAdapter {
		public View getView(int position, View convertView, ViewGroup parent) {
			if (null == convertView) {
				LayoutInflater factory = LayoutInflater.from(XunFeiSpeechMainActivity.this);
				View mView = factory.inflate(R.layout.list_items, null);
				convertView = mView;
			}
			
			Button btn = (Button) convertView.findViewById(R.id.btn);
			btn.setOnClickListener(XunFeiSpeechMainActivity.this);
			btn.setTag(position);
