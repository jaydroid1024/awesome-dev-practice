//package com.jay.lib_kotlin.coroutine.coroutinebasics.eg.lua
//
...
//
//        suspend fun main(block: suspend SymCoroutineBody.() -> Unit) {
//            SymCoroutine<Any?> { block() }.also { main = it }.start(Unit)
//        }
//
//        fun <T> create(
//            context: CoroutineContext = EmptyCoroutineContext,
//            block: suspend SymCoroutineBody.(T) -> Unit
//        ): SymCoroutine<T> {
...
//        var result = transfer(
//            com.jay.lib_kotlin.coroutine.coroutinebasics.eg.lua.SymCoroutines.coroutine2,
//            0
//        )
//        log("coroutine-0 1", result)
//        result =
//            transfer(com.jay.lib_kotlin.coroutine.coroutinebasics.eg.lua.SymCoroutine.main, Unit)
//        log("coroutine-0 1", result)
//    }
//
...
//        val result = transfer(
//            com.jay.lib_kotlin.coroutine.coroutinebasics.eg.lua.SymCoroutines.coroutine0,
//            1
//        )
...
//        var result = transfer(
//            com.jay.lib_kotlin.coroutine.coroutinebasics.eg.lua.SymCoroutines.coroutine1,
//            2
//        )
