...
public class TtsDemo extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 云端发音人名称列表
		cloudVoicersEntries = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_cloud_entries);
		cloudVoicersValue = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_cloud_values);

		// 本地发音人名称列表
		localVoicersEntries = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_local_entries);
		localVoicersValue = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_local_values);

		// 增强版发音人名称列表
		xttsVoicersEntries = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_xtts_entries);
		xttsVoicersValue = getResources().getStringArray(com.iflytek.mscv5plusdemo.R.array.voicer_xtts_values);
	...
	private void initLayout() {
		findViewById(com.iflytek.mscv5plusdemo.R.id.tts_play).setOnClickListener(this);

		findViewById(com.iflytek.mscv5plusdemo.R.id.tts_cancel).setOnClickListener(this);
		findViewById(com.iflytek.mscv5plusdemo.R.id.tts_pause).setOnClickListener(this);
		findViewById(com.iflytek.mscv5plusdemo.R.id.tts_resume).setOnClickListener(this);
		findViewById(com.iflytek.mscv5plusdemo.R.id.image_tts_set).setOnClickListener(this);

		findViewById(com.iflytek.mscv5plusdemo.R.id.tts_btn_person_select).setOnClickListener(this);

		mRadioGroup=((RadioGroup) findViewById(com.iflytek.mscv5plusdemo.R.id.tts_rediogroup));
		mRadioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {

			@Override
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				if (checkedId == com.iflytek.mscv5plusdemo.R.id.tts_radioCloud) {
					mEngineType = SpeechConstant.TYPE_CLOUD;
				} else if (checkedId == com.iflytek.mscv5plusdemo.R.id.tts_radioLocal) {
					mEngineType = SpeechConstant.TYPE_LOCAL;
				} else if (checkedId == com.iflytek.mscv5plusdemo.R.id.tts_radioXtts) {
	...
	public void onClick(View view) {
		...
		if (id == com.iflytek.mscv5plusdemo.R.id.image_tts_set) {
			...
			String text = ((EditText) findViewById(com.iflytek.mscv5plusdemo.R.id.tts_text)).getText().toString();
			// 设置参数
			setParam();
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
							...
							new DialogInterface.OnClickListener() { // 点击单选框后的处理
								public void onClick(DialogInterface dialog, int which) { // 点击了哪一项
									...
									if ("catherine".equals(voicerCloud) || "henry".equals(voicerCloud) || "vimary".equals(voicerCloud)) {
										((EditText) findViewById(com.iflytek.mscv5plusdemo.R.id.tts_text)).setText(com.iflytek.mscv5plusdemo.R.string.text_tts_source_en);
									} else {
										((EditText) findViewById(com.iflytek.mscv5plusdemo.R.id.tts_text)).setText(com.iflytek.mscv5plusdemo.R.string.text_tts_source);
									}
	...
	private SynthesizerListener mTtsListener = new SynthesizerListener() {
		...
		public void onBufferProgress(int percent, int beginPos, int endPos,
			...
			showTip(String.format(getString(com.iflytek.mscv5plusdemo.R.string.tts_toast_format),
